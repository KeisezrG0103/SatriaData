...
img = cv.imread("E:\\SatdatRapi\\V2\\TESTEDITED\\DataTest91.png")
...
if index_chars_candidate == []:
    ...
    cv.putText(img_plate_rgb3, plate_number, (50, 50), cv.FONT_ITALIC, 2.0, (0, 0, 255), 3)
    print('\nHasil Deteksi dan Pembacaan : ', plate_number)
    cv.imshow('Hasil Deteksi dan Pembacaan', img_plate_rgb3)
cv.waitKey(0)
    # ==== Cek Klasifikasi Karakter END ====
